...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640512818
...
sd "\-lfluidsynth" -- "-Wl,--whole-archive,/usr/lib64/libfluidsynth.a,,/usr/lib64/libsndfile.a,/usr/lib64/libFLAC.a,/usr/lib64/libopus.a,/usr/lib64/libvorbis.a,/usr/lib64/libvorbisenc.a,/usr/lib64/libvorbisfile.a,/usr/lib64/libogg.a,-lgomp,-lasound,-lpipewire-0.3,-lgmodule-2.0,-lglib-2.0,-lpcre,-lpthread,-ldl,-lm,-lmvec,--no-whole-archive" $(fd -uu Makefile)
## make_prepend end
